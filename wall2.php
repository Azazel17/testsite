...
//include_once("othertest.php");//include header
//session_start();
...
//for get wall post list getWallPost() function define in functions.php file
        ...
        <div class="feed_div" id="feed_div">
            ...
            if($postdata){
                ...
                foreach($postdata as $post){
                    //For get post comment list using post id
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.ResponseCode == 200){
                        $('#postbox_'+post_id).load('<?php echo SITE_URL; ?>/wall.php #postbox_'+post_id+' >*');//for refresh post box and comment list
                    }else{
